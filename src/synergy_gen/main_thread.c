...
{ .p_info = &g_transfer6_info, .activation_source = ELC_EVENT_SCI0_TXI, .auto_enable = false, .p_callback = NULL,
  .p_context = &g_transfer6, .irq_ipl = (BSP_IRQ_DISABLED) };
...
#undef SYNERGY_NOT_DEFINED            
  .rxi_ipl = (12),
  .txi_ipl = (12), .tei_ipl = (12), .eri_ipl = (13), };
...
{ .p_info = &g_transfer5_info, .activation_source = ELC_EVENT_IIC0_RXI, .auto_enable = false, .p_callback = NULL,
...
{ .p_info = &g_transfer4_info, .activation_source = ELC_EVENT_IIC0_TXI, .auto_enable = false, .p_callback = NULL,
...
{ .mode = TIMER_MODE_PERIODIC, .period = 1, .unit = TIMER_UNIT_PERIOD_MSEC, .duty_cycle = 1, .duty_cycle_unit =
          TIMER_PWM_UNIT_RAW_COUNTS,
