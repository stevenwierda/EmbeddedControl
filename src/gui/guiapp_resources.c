...
GX_CONST GX_UBYTE display_1_STRING_15_English[] = "previous";
GX_CONST GX_UBYTE display_1_STRING_16_English[] = "NEXT";

/* String Table for display_1 language English                                 */

GX_CONST GX_STRING display_1_English_string_table[58] =
{
    {GX_NULL, 0},
